...
select
    ...
    case when !isnull(at(`month`, 0)) over calendar_wday_date_0s_32d_100 then count_where(`month`, `month` = at(`month`, 0)) over calendar_wday_date_0s_32d_100 else null end as calendar_month_window_count_20,
    fz_top1_ratio(`snap_TX`) over calendar_event_name_2_date_0s_64d_200 as calendar_snap_TX_window_top1_ratio_21,
    fz_top1_ratio(`snap_TX`) over calendar_event_name_2_date_0s_14d_200 as calendar_snap_TX_window_top1_ratio_22,
    fz_top1_ratio(`snap_WI`) over calendar_event_name_2_date_0s_64d_200 as calendar_snap_WI_window_top1_ratio_23,
    ...
    distinct_count(`event_type_1`) over calendar_snap_CA_date_0s_64d_100 as calendar_event_type_1_window_unique_count_26,
    ...
    case when !isnull(at(`month`, 0)) over calendar_event_name_2_date_0s_64d_200 then count_where(`month`, `month` = at(`month`, 0)) over calendar_event_name_2_date_0s_64d_200 else null end as calendar_month_window_count_31,
    case when !isnull(at(`month`, 0)) over calendar_event_name_2_date_0s_14d_200 then count_where(`month`, `month` = at(`month`, 0)) over calendar_event_name_2_date_0s_14d_200 else null end as calendar_month_window_count_32,
    fz_top1_ratio(`event_type_1`) over calendar_event_name_2_date_0s_64d_200 as calendar_event_type_1_window_top1_ratio_33
from
    `calendar`
    window calendar_wday_date_0s_32d_100 as (partition by `wday` order by `date` rows_range between 32d open preceding and 0s preceding MAXSIZE 100),
    calendar_event_name_2_date_0s_64d_200 as (partition by `event_name_2` order by `date` rows_range between 64d open preceding and 0s preceding MAXSIZE 200),
    calendar_event_name_2_date_0s_14d_200 as (partition by `event_name_2` order by `date` rows_range between 14d open preceding and 0s preceding MAXSIZE 200),
